                        ...
                        <>
                            ...
                            <Flex
                                ...
                                {about.work.experiences.map((experience, index) => (
                                    <Flex
                                        key={`${getLocalized(experience.company)}-${getLocalized(experience.role)}-${index}`}
                                        fillWidth
                                        direction="column">
                                        <Flex
                                            fillWidth
                                            ...
                                            marginBottom="4">
                                            <Text
                                                id={typeof experience.company === 'string' ? experience.company : ''}
                                            ...
                                            <Text
                                                ...
                                                onBackground="neutral-weak">
                                                {getLocalized(experience.timeframe)}
                                            </Text>
                                        </Flex>
                                        <Text
                        ...
                        <>
                            ...
                            <Flex
                                ...
                                {about.studies.institutions.map((institution, index) => (
                                    <Flex
                                        key={`${getLocalized(institution.name)}-${index}`}
                                        fillWidth gap="4"
                                        direction="column">
                                        <Text
                                            id={typeof institution.name === 'string' ? institution.name : ''}
                                            variant="heading-strong-l">
                                            {getLocalized(institution.name)}
                                        </Text>
                                        <Text
                                            variant="heading-default-xs"
                                            onBackground="neutral-weak">
                                            {getLocalized(institution.description)}
                                        </Text>
                                    </Flex>
                                ))}
                            </Flex>
